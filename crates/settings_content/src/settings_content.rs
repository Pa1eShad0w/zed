...
fallible_options::flattened_deserialize!(SettingsContent {
    ...
    options: {
        ...
        agent_servers, audio, auto_update, auto_update_server_url, base_keymap, collaboration_panel,
        debugger, diagnostics,
        git,
        global_lsp_settings, image_viewer, markdown_preview, repl, helix_mode, hide_mouse,
        journal, log, line_indicator_format, language_models, outline_panel, perforce, project_panel,
